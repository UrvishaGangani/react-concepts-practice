            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex-1 space-y-6">
                  <div>
                    <span className="text-orange-600 dark:text-orange-400 text-sm font-semibold uppercase tracking-wider">
                      {feature.subtitle}
                    </span>
                    <h3 className="text-3xl font-bold text-white dark:text-white mt-2">
                      {feature.title}
                    </h3>
                  </div>
